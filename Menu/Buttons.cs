    ...
    public class Buttons
    {
        ...
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods [0]
                ...
                new ButtonInfo { buttonText = "Rig Mods", method =() => currentCategory = 6, isTogglable = false, toolTip = "Opens the rig mods tab."},
            },
            ...
            new ButtonInfo[] { // Movement Settings [3]
                ...
                new ButtonInfo { buttonText = "Change Speedboost Speed", overlapText = "Change Speedboost Speed [Normal]", method =() => Mods.Settings.Movement.ChangeFlySpeed(), isTogglable = false, toolTip = "Changes the speed of the fly mod."},
            },
            ...
            new ButtonInfo[] { // Movement Mods [5]
                ...
                new ButtonInfo { buttonText = "GripFly", method =() => Movement.GripFly(), toolTip = "Sends you forward when holding Your Grip."},
                ...
                new ButtonInfo { buttonText = "Speedboost", method =() => Movement.speedboost(), toolTip = "Gives youu a speedboost."},
            },

            new ButtonInfo[] { // Rig Mods [6]
                new ButtonInfo { buttonText = "Return to Main", method =() => currentCategory = 0, isTogglable = false, toolTip = "Returns to the main page of the menu."},
                new ButtonInfo { buttonText = "Ghost Monke", method =() => Rig.GhostMonke(), toolTip = "Makes your rig stay still while holding your primary button."},
                new ButtonInfo { buttonText = "Noclip", method =() => Rig.Noclip(), toolTip = "Removes the hitboxes on your rig."}
            },
