...
namespace StupidTemplate
{
    public class Settings
    {
        ...
        public static ExtGradient backgroundColor = new ExtGradient { colors = ExtGradient.GetSolidGradient(Color.purple) };
        public static ExtGradient[] buttonColors = new ExtGradient[]
        {
            new ExtGradient { colors = ExtGradient.GetSolidGradient(Color.plum) }, // Disabled
